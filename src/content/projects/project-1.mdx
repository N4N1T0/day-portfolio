...
<Image src='/project-1.jpg' alt='Project preview' width={800} height={600} title='Project preview' loading='eager' />
...
<Image src='/Dates.jpg' alt='Dates of the Campaign' width={800} height={600} title='Dates of the Campaign' />

#### **progress**

<Image src='/Progress.jpg' alt='Progress of the Campaign' width={800} height={600} title='Progress of the Campaign' />
...
<Image src='/chart.jpg' alt='Dates of the Campaign' width={800} height={600} title='Dates of the Campaign' />
...
<Image src='/project-1-Suggested FB Campaign_5.jpg' alt='Other Suggestions' width={800} height={600} title='Other Suggestions' />
...
<p class='quote-name'>Comunication Manager</p>
<p class='quote-name !-mt-5'>Chloé Carpentier</p>
